...
문제의 필승 조건 : n * m의 전체 map을 floor(n / k) * floor(m / k)로 나눈 후, 남은 칸의 수가 짝수(자신이 마지막으로 놓을 수 있도록)이 유지되게 하면서 진행<br>
위 필승조건에 따라, 첫 수에 끝나는 조건과 첫 수 안에 끝나지 않을땐 n * m이 짝수인지 아닌지 2가지에 대해서 체크하면 최후의 승자를 가릴 수 있다.
